...
const Profile = () => {
    ...
    const [userData, setUserData] = useState({
        ...
        email: 'harshul@gmail.com',
        phone: '+91 9999988888',
        address: {
            line1: "vaishnodevi circle",
            line2: "Khoraj, Adalaj, Gandhinagar",
        },
        gender: "Male",
        dob: '2002-11-26',
    })
    ...
    return (
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
            ...
            {
                isEdit
                    ? <input className='bg-gray-50 text-3xl font-medium mt-4 max-w-60' type="text" value={userData.name} onChange={(e) => setUserData(prev => ({ ...prev, name: e.target.value }))} />
